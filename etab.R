...
etablissements <- etablissements_tot[, c("A101" ,"EFF_ET", "EFF_TR_ET" ,"REGION_ET", "SIRET")] %>% 
  filter(EFF_TR_ET!="NN")
...
etab_macro <- etab_macro[, c("siret_AF","EFF_TR_ET", "EFF_ET", "A101")] %>% 
  group_by(siret_AF, EFF_TR_ET, EFF_ET, A101) %>% 
...
labels <- c("0 salarié","1 à 2 salariés","3 à 5 salariés", "6 à 9 salariés","10 à 19 salariés", "20 à 49 salariés",
